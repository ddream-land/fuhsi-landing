...
import { ref, defineComponent, computed, openBlock, createElementBlock, mergeProps, unref, renderSlot, watch, nextTick, provide, reactive, onUpdated, normalizeClass, createElementVNode, normalizeStyle, createBlock, resolveDynamicComponent, withCtx, createCommentVNode, inject, withDirectives, cloneVNode, Fragment, Text, Comment, createVNode, toRef, Teleport, Transition, vShow, readonly, toDisplayString, withModifiers, getCurrentInstance, warn, shallowRef, useSlots, useSSRContext, isRef, resolveComponent, normalizeProps, guardReactiveProps, createSlots, createTextVNode, renderList } from 'vue';
import { isNil, castArray, fromPairs, isUndefined as isUndefined$1, get } from 'lodash-unified';
import { NOOP, isObject, isString, hasOwn, isFunction, isArray } from '@vue/shared';
import { e as useNamespace, f as isUndefined, h as useId, b as isBoolean, j as caret_top_default, k as arrow_down_default, _ as _export_sfc$1, i as isNumber, a as isStringNumber, u as useGetDerivedNamespace, c as useIdInjection, g as useZIndex, l as loading_default, n as useRoute, m as useI18n, t as throwError } from './server.mjs';
...
var ElFocusTrap = /* @__PURE__ */ _export_sfc(_sfc_main$j, [["render", _sfc_render$9], ["__file", "focus-trap.vue"]]);
...
var Backtop = /* @__PURE__ */ _export_sfc(_sfc_main$e, [["__file", "backtop.vue"]]);
...
var Collection = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["render", _sfc_render$8], ["__file", "collection.vue"]]);
...
var CollectionItem = /* @__PURE__ */ _export_sfc(_sfc_main$a, [["render", _sfc_render$7], ["__file", "collection-item.vue"]]);
...
var ElRovingFocusGroupImpl = /* @__PURE__ */ _export_sfc(_sfc_main$9, [["render", _sfc_render$6], ["__file", "roving-focus-group-impl.vue"]]);
...
var ElRovingFocusGroup = /* @__PURE__ */ _export_sfc(_sfc_main$8, [["render", _sfc_render$5], ["__file", "roving-focus-group.vue"]]);
...
var ElRovingFocusItem = /* @__PURE__ */ _export_sfc(_sfc_main$7, [["render", _sfc_render$4], ["__file", "roving-focus-item.vue"]]);
...
var Dropdown = /* @__PURE__ */ _export_sfc(_sfc_main$6, [["render", _sfc_render$3], ["__file", "dropdown.vue"]]);
...
var ElDropdownItemImpl = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["render", _sfc_render$2], ["__file", "dropdown-item-impl.vue"]]);
const useDropdown = () => {
...
var DropdownItem = /* @__PURE__ */ _export_sfc(_sfc_main$4, [["render", _sfc_render$1], ["__file", "dropdown-item.vue"]]);
...
var DropdownMenu = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["render", _sfc_render], ["__file", "dropdown-menu.vue"]]);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(navigation, (item) => {
        _push(`<!--[-->`);
        if (!!item.id) {
          _push(`<div class="hover:text-gray-300 hover:underline md:text-lg text-base flex items-center 2xl:px-6 xl:px-4 md:px-2 cursor-pointer">${ssrInterpolate(_ctx.$t(item.name))}</div>`);
        } else {
          _push(ssrRenderComponent(_component_NuxtLink, {
            to: item.href,
            class: ["hover:text-gray-300 md:text-lg text-base flex items-center 2xl:px-6 xl:px-4 md:px-2", { "active": unref(path) === item.href }],
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_NuxtImg = __nuxt_component_0$1;
  const _component_Icon = __nuxt_component_1$1;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "text-[#666666] bg-black pt-14" }, _attrs))}><div class="px-6 md:w-[70%] w-[90%] mx-auto"><div class="grid md:grid-cols-3 grid-cols-1"><div class="md:pb-14 pb-4 flex items-center">`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc$1(_sfc_main$1, [["ssrRender", _sfc_ssrRender]]);
const _sfc_main = {
  __name: "default",
  __ssrInlineRender: true,
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<!--[--><div class="gd-container" data-v-d3848e8f><header class="${ssrRenderClass([{ "skicy": unref(scrollTop) > 500 }, "fixed w-full z-10"])}" data-v-d3848e8f>`);
      _push(ssrRenderComponent(_component_MainHeader, null, null, _parent));
      _push(`</header><main class="pt-28 mmm" style="${ssrRenderStyle({ "z-index": "1" })}" data-v-d3848e8f>`);
      ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
      _push(`</main><footer data-v-d3848e8f>`);
