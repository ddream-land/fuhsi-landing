import { _ as __nuxt_component_0 } from './nuxt-link-BdzsTFP1.mjs';
import { _ as __nuxt_component_0$1 } from './nuxt-img-_1y8giuP.mjs';
import { defineComponent, ref, computed, watch, nextTick, provide, reactive, onUpdated, openBlock, createElementBlock, normalizeClass, unref, createElementVNode, normalizeStyle, createBlock, resolveDynamicComponent, withCtx, renderSlot, createCommentVNode, inject, withDirectives, cloneVNode, Fragment, Text, Comment, createVNode, mergeProps, toRef, Teleport, Transition, vShow, readonly, toDisplayString, getCurrentInstance, useSlots, useSSRContext, shallowRef, resolveComponent, normalizeProps, guardReactiveProps, createSlots, withModifiers, createTextVNode, renderList } from 'vue';
import { l as buildProp, b as buildProps, c as addUnit, w as withInstall, d as definePropType, E as ElFocusTrap, m as EVENT_CODE, e as ElIcon, n as withNoopInstall, a as useLocale, F as FOCUS_TRAP_INJECTION_KEY, _ as _export_sfc$1, u as useDeprecated, f as useGlobalConfig, i as iconPropType, k as ElBacktop } from './el-backtop-4RXX1VYb.mjs';
import { u as useNamespace, c as useId, i as isBoolean, m as arrow_down_default, _ as _export_sfc, g as useGetDerivedNamespace, h as useIdInjection, j as isNumber, b as useZIndex, l as loading_default, n as useRoute, f as useI18n, t as throwError } from './server.mjs';
import { TinyColor } from '@ctrl/tinycolor';
import { useResizeObserver, useEventListener, onClickOutside, tryOnScopeDispose, isClient, unrefElement } from '@vueuse/core';
...
var Collection = /* @__PURE__ */ _export_sfc$1(_sfc_main$b, [["render", _sfc_render$8], ["__file", "collection.vue"]]);
...
var CollectionItem = /* @__PURE__ */ _export_sfc$1(_sfc_main$a, [["render", _sfc_render$7], ["__file", "collection-item.vue"]]);
...
var ElRovingFocusGroupImpl = /* @__PURE__ */ _export_sfc$1(_sfc_main$9, [["render", _sfc_render$6], ["__file", "roving-focus-group-impl.vue"]]);
...
var ElRovingFocusGroup = /* @__PURE__ */ _export_sfc$1(_sfc_main$8, [["render", _sfc_render$5], ["__file", "roving-focus-group.vue"]]);
...
var ElRovingFocusItem = /* @__PURE__ */ _export_sfc$1(_sfc_main$7, [["render", _sfc_render$4], ["__file", "roving-focus-item.vue"]]);
...
var Dropdown = /* @__PURE__ */ _export_sfc$1(_sfc_main$6, [["render", _sfc_render$3], ["__file", "dropdown.vue"]]);
...
var ElDropdownItemImpl = /* @__PURE__ */ _export_sfc$1(_sfc_main$5, [["render", _sfc_render$2], ["__file", "dropdown-item-impl.vue"]]);
const useDropdown = () => {
...
var DropdownItem = /* @__PURE__ */ _export_sfc$1(_sfc_main$4, [["render", _sfc_render$1], ["__file", "dropdown-item.vue"]]);
...
var DropdownMenu = /* @__PURE__ */ _export_sfc$1(_sfc_main$3, [["render", _sfc_render], ["__file", "dropdown-menu.vue"]]);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div class="flex items-center"><nav class="hidden lg:flex mr-4">`);
      ...
      _push(`</nav>`);
      _push(ssrRenderComponent(_component_el_dropdown, { onCommand: onLanguageChange }, {
          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_el_dropdown_menu, null, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<!--[-->`);
                  ssrRenderList(unref(locales), (lol) => {
                    _push3(ssrRenderComponent(_component_el_dropdown_item, {
                      key: lol.code,
                      command: lol.code,
                      disabled: unref(locale) === lol.code
                    }, {
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          _push4(`${ssrInterpolate(lol.name)}`);
                        } else {
                          return [
                            createTextVNode(toDisplayString(lol.name), 1)
                          ];
                        }
                      }),
                      _: 2
                  ...
                  return [
                    (openBlock(true), createBlock(Fragment, null, renderList(unref(locales), (lol) => {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_Icon, {
              name: "gis:earth-euro-africa-o",
              size: "20",
              class: "md:mr-36 mr-12 cursor-pointer hover:text-[#8affd4]"
            }, null, _parent2, _scopeId));
          } else {
            return [
      ...
      _push(`</div><button class="lg:hidden mr-4"><svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 6h16M4 12h16m-7 6h7"></path></svg></button>`);
      if (unref(isOpen)) {
