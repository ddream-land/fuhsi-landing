import { hasInjectionContext, inject, version, unref, toRef, isRef, defineComponent, ref, provide, createElementBlock, defineAsyncComponent, h, getCurrentInstance, onUnmounted, computed, useSSRContext, shallowReactive, watch, Suspense, nextTick, Transition, Fragment, openBlock, createElementVNode, reactive, mergeProps, withCtx, createVNode, createApp, effectScope, shallowRef, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, isReadonly, Text, markRaw, isShallow, isReactive, toRaw } from 'vue';
import { $ as $fetch, l as defu, m as sanitizeStatusCode, n as createHooks, h as createError$1, t as toRouteMatcher, o as createRouter$1, p as klona, q as parse$1, r as getRequestHeader, v as getRequestHeaders, w as destr, x as isEqual$1, y as setCookie, z as getCookie, A as deleteCookie } from '../runtime.mjs';
import { b as baseURL } from '../routes/renderer.mjs';
import { getActiveHead } from 'unhead';
import { defineHeadPlugin } from '@unhead/shared';
import { useRoute as useRoute$1, RouterView, createMemoryHistory, createRouter, START_LOCATION } from 'vue-router';
import { isClient } from '@vueuse/core';
import { isString as isString$1 } from '@vue/shared';
...
const defaultNamespace$1 = _globalThis[globalKey$2] || (_globalThis[globalKey$2] = createNamespace$1());
...
const unhead_LnB9aLELJ5 = /* @__PURE__ */ defineNuxtPlugin({
  name: "nuxt:head",
  enforce: "pre",
  setup(nuxtApp) {
...
const _routes = [
  ...
  },
  {
    ...
    component: () => import('./index-tXO8MXIG.mjs').then((m) => m.default || m)
  }
];
...
const default_45global = /* @__PURE__ */ defineNuxtRouteMiddleware((to, from) => {
});
...
const revive_payload_server_aCd5kyANw0 = /* @__PURE__ */ defineNuxtPlugin({
...
const LazyIcon = defineAsyncComponent(() => import('./Icon-CP5qx6M3.mjs').then((r) => r["default"] || r.default || r));
const LazyIconCSS = defineAsyncComponent(() => import('./IconCSS-Cv0Pi14D.mjs').then((r) => r["default"] || r.default || r));
...
function onBeforeLanguageSwitch(i18n, oldLocale, newLocale, initial2, context) {
...
const i18n_8Oaya4b5uV = /* @__PURE__ */ defineNuxtPlugin({
  name: "i18n:plugin",
...
const plugin_55yIplBJ93 = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
  const {
    cookieOptions,
    debug,
    storage
...
const directives = {};
const directives_8CcCirWtnE = /* @__PURE__ */ defineNuxtPlugin((nuxtApp) => {
...
const global_2XP5sjpyNs = /* @__PURE__ */ defineNuxtPlugin((NuxtApp) => {
...
const plugins = [
  ...
  plugin$1,
  plugin,
  revive_payload_server_aCd5kyANw0,
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const PageLoadingConfig = reactive({
      state: true
    });
...
const layouts = {
  avatar: () => import('./avatar-CkJqxs-o.mjs').then((m) => m.default || m),
...
const _sfc_main$2 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      const _component_PageLoading = __nuxt_component_0;
      const _component_NuxtLayout = __nuxt_component_1;
      const _component_NuxtPage = __nuxt_component_2;
      _push(`<!--[-->`);
      _push(ssrRenderComponent(_component_PageLoading, null, null, _parent));
      _push(ssrRenderComponent(_component_NuxtLayout, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_component_NuxtPage, {
              "page-key": _ctx.$route.fullPath
...
_sfc_main$1.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.2_@unocss+reset@0.59.4_axios@1.6.8_floating-vue@5.2.2_nprogress@0.2.0_rollup@4.16.1_yvwgsdqc545v6nlafgslalg2be/node_modules/nuxt/dist/app/components/nuxt-error-page.vue");
...
_sfc_main.setup = (props, ctx) => {
  const ssrContext = useSSRContext();
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("node_modules/.pnpm/nuxt@3.11.2_@unocss+reset@0.59.4_axios@1.6.8_floating-vue@5.2.2_nprogress@0.2.0_rollup@4.16.1_yvwgsdqc545v6nlafgslalg2be/node_modules/nuxt/dist/app/components/nuxt-root.vue");
